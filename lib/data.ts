...
export const SHOWCASE_PROJECTS: ProjectShowcaseItem[] = [
  {
    ...
    challenge:
      'The client operated across 14 distribution centers using fragmented legacy spreadsheets and disparate tracking portals, creating routing delays and blind spots in inventory transit.',
    solution:
      'Engineered a centralized, event-driven web dashboard in Next.js with WebSocket streaming, sub-second route calculation, role-based dispatcher views, and automated carrier status alerts.',
    technologies: ['Next.js', 'TypeScript', 'Node.js Microservices', 'PostgreSQL', 'Redis', 'Docker'],
    keyCapabilities: [
      'Sub-50ms live vehicle telemetry streaming',
      'Dynamic multi-stop route optimization engine',
      'Automated dispatch workflow with instant SMS/Email triggers',
      'Enterprise role-based security with fine-grained audit logs',
    ],
    ...
    metrics: [
      ...
      { label: 'Dispatch Throughput', value: '12k/day' },
  ...
  },
  {
    ...
    challenge:
      'Manual multi-bank reconciliation created high operational overhead and settlement delays for a regional trade financing network handling multi-party transactions.',
    solution:
      'Constructed a zero-trust financial portal with double-entry ledger verification, automated webhook notifications, exportable tax reports, and encrypted banking integrations.',
    technologies: ['Next.js 15', 'TypeScript', 'PostgreSQL', 'Prisma ORM', 'Stripe Connect', 'AWS KMS'],
    keyCapabilities: [
      'Immutable double-entry audit ledger with cryptographic validation',
      'Automated daily bank reconciliation and batch payouts',
      'Multi-tenant partner sub-accounts with custom permission matrices',
      'SOC2-aligned data encryption in transit and at rest',
    ],
    architectureOverview:
    ...
    badgeColor: 'purple',
    metrics: [
      { label: 'Reconciliation Time', value: 'Real-Time' },
      { label: 'Compliance Level', value: 'SOC2 / PCI' },
  ...
  },
  {
    ...
    challenge:
      'Customer support representatives spent up to 25 minutes per inquiry manually searching through thousands of PDF technical manuals and compliance bylaws.',
    solution:
      'Built a private AI knowledge retrieval assistant using vector embeddings, hybrid semantic search, and streaming responses with direct citation verification.',
    technologies: ['Google GenAI', 'Next.js App Router', 'pgvector / PostgreSQL', 'FastAPI', 'Tailwind CSS'],
    keyCapabilities: [
      'Instant contextual document parsing across PDF, DOCX, and scanned records',
      'Strict halluncination guardrails with source document citations',
      'Interactive feedback loop and human-in-the-loop review workflow',
      'Enterprise data privacy with no third-party training retention',
    ],
    architectureOverview:
    ...
    badgeColor: 'blue',
    metrics: [
      { label: 'Retrieval Speed', value: '420ms' },
      { label: 'Accuracy Verification', value: '99.4%' },
      { label: 'Time Saved per Case', value: '82%' },
    ],
  },
  {
    ...
    challenge:
      'A specialty hardware distributor struggled with an outdated Magento store that could not handle negotiated customer pricing tiers, credit terms, or complex freight calculations.',
    solution:
      'Designed and deployed a headless commerce storefront utilizing Next.js, custom microservices for dynamic pricing algorithms, and bi-directional ERP synchronization.',
    ...
    keyCapabilities: [
      ...
      'Instant digital quote generation with multi-level manager approval',
    ...
    metrics: [
      ...
      { label: 'Catalog SKU Count', value: '45,000+' },
  ...
  },
  {
    ...
    challenge:
      'Field technicians operating in low-connectivity industrial environments suffered lost reports, duplicate paperwork, and hours of delayed data entry every evening.',
    solution:
      'Engineered an offline-capable React Native application with local SQLite caching, camera-based barcode diagnostics, digital signature capture, and automated background sync.',
    ...
    metrics: [
      ...
      { label: 'Daily Field Reports', value: '3,500+' },
  ...
  },
  {
    ...
    challenge:
      'A high-growth cybersecurity firm had a disjointed marketing website built on a heavy WordPress stack that suffered from slow mobile speeds and low demo conversion rates.',
    solution:
      'Architected a lightning-fast Next.js digital experience with responsive interactive feature visualizers, programmatic security compliance hubs, and direct CRM pipeline integration.',
    technologies: ['Next.js App Router', 'TypeScript', 'Tailwind CSS', 'Motion', 'Sanity CMS', 'HubSpot API'],
    keyCapabilities: [
      'Sub-600ms Time to Interactive (TTI) across global CDN edge nodes',
      'Interactive architecture explorer and compliance framework navigator',
      'Smart lead capture forms with real-time company domain enrichment',
      'Accessibility compliant WCAG AA layout with custom keyboard navigation',
    ],
    architectureOverview:
    ...
    badgeColor: 'purple',
    metrics: [
      { label: 'Mobile LCP', value: '0.7s' },
      { label: 'Lead Conversion Lift', value: '+44%' },
