...
import { Menu, X, ArrowRight, Sparkles, Shield, Terminal } from 'lucide-react';
  ...
  return (
    <header
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled
          ? 'bg-[#060911]/90 backdrop-blur-md border-b border-slate-800/80 shadow-lg shadow-black/40 py-3.5'
          : 'bg-transparent py-5'
      }`}
    >
          ...
          >
            ...
            <div className="pt-3 border-t border-slate-800/80">
              <button
                ...
                className="w-full py-3 px-4 rounded-lg bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium text-sm flex items-center justify-center gap-2 shadow-lg shadow-blue-600/30"
              >
                <span>Start a Project</span>
                <ArrowRight className="w-4 h-4" />
              </button>
